<?php return array (
  ...
  array (
    ...
    'faker_locale' => 'en_US',
    'cipher' => 'AES-256-CBC',
    'key' => 'base64:xIvqnWYmskKLy+rC302bKOLVpFFnSLVWV7Z+Pn1E54I=',
    'previous_keys' => 
    array (
    ),
    'maintenance' => 
    ...
    array (
      ...
      'Old' => 'Illuminate\\Support\\Facades\\Session',
  ...
  array (
    ...
    'prefix' => 'medici-di-famiglia-cache-',
  ),
  'database' => 
  array (
    'default' => 'mysql',
    ...
    array (
      ...
      array (
        'driver' => 'sqlite',
        'url' => NULL,
        'database' => 'crmmedici_di_famiglia',
        'prefix' => '',
    ...
    array (
      ...
      array (
        'cluster' => 'redis',
        'prefix' => 'medici-di-famiglia-database-',
        'persistent' => false,
      ),
      'default' => 
      array (
  ...
  array (
    ...
    'from' => 
    array (
      'address' => 'a.fragalework@gmail.com',
      'name' => 'Medici di Famiglia',
    ),
    'markdown' => 
    array (
  ...
  array (
    ...
    'cookie' => 'medici-di-famiglia-session',
    'path' => '/',
    'domain' => NULL,
    'secure' => NULL,
    'http_only' => true,
